...
namespace trui {
  ...
  void Oc::PIDvelocity_algorithm(float speed,float Kp,float Ki,float Kd,float delta_T){
  ...
  float Oc::set_orientation(float cmd_speed) {
