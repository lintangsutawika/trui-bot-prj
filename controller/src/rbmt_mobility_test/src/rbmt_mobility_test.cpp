...
namespace rbmt_mobility_test {

MobilityTest::MobilityTest(ros::NodeHandle nh): nh_(nh) {

  joy_sub_ = nh_.subscribe<std_msgs::Int16MultiArray>("read_joy",1, &MobilityTest::joy_sub_cb, this);//get controller command from /read_joy topic
  // kinect_sub_ = nh_.subscribe<geometry_msgs::Twist>("kinect_velocity",1, &MobilityTest::kinect_sub_cb, this);//get controller command from /read_joy topic
...
// void MobilityTest::kinect_sub_cb(const geometry_msgs::Twist::ConstPtr& vel_msg) {
//   vel_kinect_x_ = vel_msg->linear.x;
//   vel_kinect_y_ = vel_msg->linear.y;
//   vel_kinect_z_ = vel_msg->angular.z;
// }

void MobilityTest::joy_sub_cb(const std_msgs::Int16MultiArray::ConstPtr& msg) {
  axisX_          = msg->data[0];
  axisY_          = msg->data[1];
  //= msg->data[2];
  //= msg->data[3];
...
void MobilityTest::run(ros::Rate rate) {
